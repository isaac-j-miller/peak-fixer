...
water.simulate('H2O', min_wavelength=187.0, max_wavelength=215.0, medium='vacuum',
    wavelengths=test.get_data()['wavenumber'], 
    Tgas=337.95, 
    pressure=0.000000008, isotopologues={
    1:0.9978, 
    2:0.002,
    3:0.0003,
    4:0.000149,
...
pair.subtract_secondary_spectrum_with_matching_index(1.0e8,fill_negative=True)
pair.primary.plot()
plt.show()
